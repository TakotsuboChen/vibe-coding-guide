...
担心"看不到提升的清晰路径，是不是要啃 CS 专业书系统学一遍"？这章给你一条可量化的路径。来源：TeachYourselfCS、Martin Fowler、Simon Willison、Nolan Lawson 等从业者博客。
...
**learning mode 对你学习的帮助真实但有限**：它改变了 Claude 的输出风格（会解释、会留空给你填），但它本身不会让你学会任何东西——你不主动填那些空，它就只是更啰嗦的 Claude。它的真正价值在于制造"摩擦点"，你需要主动抓住这些摩擦点。
...
这是 vibe coding 最大的学习风险。社区对此有共识：陷阱真实存在，且对被动使用者致命。
