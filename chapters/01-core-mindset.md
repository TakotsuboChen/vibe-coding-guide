...
在讲任何操作之前，先建立五个贯穿全文的心智模型。理解这五点，比记住任何命令都重要。
...
`★ Insight ─────────────────────────────────────`
这五个心智模型是递进的：上下文管理是"怎么用工具"，切片是"怎么拆任务"，主动维护是"怎么不留失忆点"，agent 边界是"怎么和工具分工"，DRI 是"怎么对自己负责"。前四个是操作层，第五个是身份层。重构版的后续章节，都是围绕怎么同时修这两层展开的。
`─────────────────────────────────────────────────`